...
Filename: "{cmd}"; Parameters: "/c xcopy /E /I /Y ""{app}\my_custom_stuff"" ""{app}\my_custom_stuff_backup"""; Flags: runhidden; StatusMsg: "Backing up my_custom_stuff folder..."; Components: MiscMods/SoundMods MiscMods/SoundMods/Snatcher MiscMods/SoundMods/SpyWard
;Huds
