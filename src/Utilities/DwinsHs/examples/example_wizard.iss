...
;  $Rev: 138 $   $Id: example_wizard.iss 138 2019-10-24 16:51:20Z hanjy $
;  Copyright(C) 2001, 2019 Han-soft Software. All rights reserved.
;-------------------------------------------------------------------------------
...
DefaultDirName = {commonpf}\My_App_2
#else
...
Source: "{tmp}\uninshs.zip"; DestDir: "{app}"; Components: ext_uninshs; \
  Flags: external; Check: DwinsHs_Check(ExpandConstant('{tmp}\uninshs.zip'), \
    'http://www.han-soft.com/download/uninshs.zip', 'My_App_2', 'get', 0, 0)
Source: "{tmp}\dwinshs.zip"; DestDir: "{app}"; Components: ext_dwinshs; \
  Flags: external; Check: DwinsHs_Check(ExpandConstant('{tmp}\dwinshs.zip'), \
    'http://www.han-soft.com/download/dwinshs.zip', 'My_App_2', 'get', 0, 0);
